---
name: context7-docs
description: "Fetch library documentation via Context7 MCP. Use when researching React, Next.js, Vue, Tailwind, MCP, or any npm library. Always use BEFORE searching external docs."
